;;; dark-fg-theme.el --- Emacs theme with a dark background.

;; Copyright (C) 2014 , Nico Sonack
...
;;; Commentary: Simple dark color theme I hacked together in one
;;; evening.
...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'dark-fg
        ...
        `(mode-line ((,class (:box (:line-width 1 :color ,bg2) :bold t :foreground ,fg4 :background ,bg2))))
...
(provide-theme 'dark-fg)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; dark-fg-theme.el ends here
